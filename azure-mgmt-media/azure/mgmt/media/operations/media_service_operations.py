...
class MediaServiceOperations(object):
    ...
    :ivar api_version: Version of the API to be used with the client request. Current version is 2015-10-01. Constant value: "2015-10-01".
    """
    ...
    def check_name_availability(
            self, check_name_availability_input, custom_headers=None, raw=False, **operation_config):
        """Checks whether the Media Service resource name is available. The name
        must be globally unique.

        :param check_name_availability_input: Properties needed to handle the
         check of the availability of a name.
        :type check_name_availability_input:
         :class:`CheckNameAvailabilityInput
         <microsoft.azure.management.media.models.CheckNameAvailabilityInput>`
        ...
        :rtype: :class:`CheckNameAvailabilityOutput
         <microsoft.azure.management.media.models.CheckNameAvailabilityOutput>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises:
         :class:`ApiErrorException<microsoft.azure.management.media.models.ApiErrorException>`
        """
        # Construct URL
    ...
    def list_by_resource_group(
        ...
        :rtype: :class:`MediaServicePaged
         <microsoft.azure.management.media.models.MediaServicePaged>`
        :raises:
         :class:`ApiErrorException<microsoft.azure.management.media.models.ApiErrorException>`
        """
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`MediaService
         <microsoft.azure.management.media.models.MediaService>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises:
         :class:`ApiErrorException<microsoft.azure.management.media.models.ApiErrorException>`
    ...
    def regenerate_key(
            self, resource_group_name, media_service_name, regenerate_key_input, custom_headers=None, raw=False, **operation_config):
        ...
        :param media_service_name: Name of the Media Service.
        :type media_service_name: str
        :param regenerate_key_input: Properties needed to regenerate the Media
         Service key.
        :type regenerate_key_input: :class:`RegenerateKeyInput
         <microsoft.azure.management.media.models.RegenerateKeyInput>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list_keys(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`ServiceKeys
         <microsoft.azure.management.media.models.ServiceKeys>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises:
         :class:`ApiErrorException<microsoft.azure.management.media.models.ApiErrorException>`
    ...
    def sync_storage_keys(
            self, resource_group_name, media_service_name, sync_storage_keys_input, custom_headers=None, raw=False, **operation_config):
        ...
        :param media_service_name: Name of the Media Service.
        :type media_service_name: str
        :param sync_storage_keys_input: Properties needed to synchronize the
         keys for a storage account to the Media Service.
        :type sync_storage_keys_input: :class:`SyncStorageKeysInput
         <microsoft.azure.management.media.models.SyncStorageKeysInput>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
